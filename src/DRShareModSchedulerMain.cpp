...
int main(int argc, char *argv[]) {
	...
	DRShareModScheduler shareScheduler(queueList, workList);
	...
	for(int i = 0; i < threads.size(); i++) {
		DRShareModWorker worker(i, numCPU, &queueList[i], &workList[i], shareScheduler);
